...
namespace Ops.Plugins.Model
{
	...
	public partial class SdkMessageFilter : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<Ops.Plugins.Model.SdkMessageProcessingStep> sdkmessagefilterid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<Ops.Plugins.Model.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntities<Ops.Plugins.Model.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null, value);
			}
		}
		...
		public Ops.Plugins.Model.SdkMessage sdkmessageid_sdkmessagefilter
		{
			get
			{
				return this.GetRelatedEntity<Ops.Plugins.Model.SdkMessage>("sdkmessageid_sdkmessagefilter", null);
			}
			set
			{
				this.SetRelatedEntity<Ops.Plugins.Model.SdkMessage>("sdkmessageid_sdkmessagefilter", null, value);
			}
		}
	}
}
