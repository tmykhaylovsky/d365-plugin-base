...
namespace Ops.Plugins.Model
{
	...
	public partial class SdkMessage : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<Ops.Plugins.Model.SdkMessageFilter> sdkmessageid_sdkmessagefilter
		{
			get
			{
				return this.GetRelatedEntities<Ops.Plugins.Model.SdkMessageFilter>("sdkmessageid_sdkmessagefilter", null);
			}
			set
			{
				this.SetRelatedEntities<Ops.Plugins.Model.SdkMessageFilter>("sdkmessageid_sdkmessagefilter", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Ops.Plugins.Model.SdkMessageProcessingStep> sdkmessageid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<Ops.Plugins.Model.SdkMessageProcessingStep>("sdkmessageid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntities<Ops.Plugins.Model.SdkMessageProcessingStep>("sdkmessageid_sdkmessageprocessingstep", null, value);
			}
		}
	}
}
