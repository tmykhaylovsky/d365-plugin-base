...
namespace Ops.Plugins.Model
{
	...
	public enum account_statuscode
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		InactiveBusiness = 884820002,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		PermanentlyClosedBusiness = 924500000,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		ResidentialBuilding = 924500001,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		NoTennisCourts = 924500002,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		Camp = 924500003,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		HomeownersAssociation_HOA = 924500004,
	}
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity
	{
		...
		public partial class Fields
		{
			...
			public const string ops_accesstype = "ops_accesstype";
			public const string ops_accountrefreshtagsrunurl = "ops_accountrefreshtagsrunurl";
			public const string ops_accounttype = "ops_accounttype";
			public const string ops_amenities = "ops_amenities";
			public const string ops_courtcount = "ops_courtcount";
			public const string ops_courtsize = "ops_courtsize";
			public const string ops_courtsurface = "ops_courtsurface";
			public const string ops_createaccountfromgpd = "ops_createaccountfromgpd";
			public const string ops_customerid = "ops_customerid";
			public const string ops_datavalidation = "ops_datavalidation";
			public const string ops_datavalidationrunurl = "ops_datavalidationrunurl";
			public const string ops_datavalidationtriggeron = "ops_datavalidationtriggeron";
			public const string ops_donotemailreason = "ops_donotemailreason";
			public const string ops_emailpattern = "ops_emailpattern";
			public const string ops_formeraccountatlocation = "ops_formeraccountatlocation";
			public const string ops_googleplaceid = "ops_googleplaceid";
			public const string ops_gp_id = "ops_gp_id";
			public const string ops_gp_query = "ops_gp_query";
			public const string ops_gp_refreshedon = "ops_gp_refreshedon";
			public const string ops_gp_refreshstatus = "ops_gp_refreshstatus";
			public const string ops_gp_response = "ops_gp_response";
			public const string ops_gp_responsejson = "ops_gp_responsejson";
			public const string ops_gp_responsestatus = "ops_gp_responsestatus";
			public const string ops_gpd_address1_city = "ops_gpd_address1_city";
			public const string ops_gpd_address1_county = "ops_gpd_address1_county";
			public const string ops_gpd_address1_latitude = "ops_gpd_address1_latitude";
			public const string ops_gpd_address1_line1 = "ops_gpd_address1_line1";
			public const string ops_gpd_address1_longitude = "ops_gpd_address1_longitude";
			public const string ops_gpd_address1_postalcode = "ops_gpd_address1_postalcode";
			public const string ops_gpd_address1_stateorprovince = "ops_gpd_address1_stateorprovince";
			public const string ops_gpd_businessname = "ops_gpd_businessname";
			public const string ops_gpd_businessstatus = "ops_gpd_businessstatus";
			public const string ops_gpd_editorialsummary = "ops_gpd_editorialsummary";
			public const string ops_gpd_enrichmentapprovalstatus = "ops_gpd_enrichmentapprovalstatus";
			public const string ops_gpd_enrichmentmodifiedby = "ops_gpd_enrichmentmodifiedby";
			public const string ops_gpd_enrichmentmodifiedon = "ops_gpd_enrichmentmodifiedon";
			public const string ops_gpd_matchconfidence = "ops_gpd_matchconfidence";
			public const string ops_gpd_matchconfidencetriggeredby = "ops_gpd_matchconfidencetriggeredby";
			public const string ops_gpd_matchconfidencetriggeredon = "ops_gpd_matchconfidencetriggeredon";
			public const string ops_gpd_phonenumber = "ops_gpd_phonenumber";
			public const string ops_gpd_rating = "ops_gpd_rating";
			public const string ops_gpd_refreshedon = "ops_gpd_refreshedon";
			public const string ops_gpd_responsejson = "ops_gpd_responsejson";
			public const string ops_gpd_responsestatus = "ops_gpd_responsestatus";
			public const string ops_gpd_url = "ops_gpd_url";
			public const string ops_gpd_url2 = "ops_gpd_url2";
			public const string ops_gpd_userratingtotal = "ops_gpd_userratingtotal";
			public const string ops_gpd_websiteurl = "ops_gpd_websiteurl";
			public const string ops_gpd_websiteurl2 = "ops_gpd_websiteurl2";
			public const string ops_importlabel = "ops_importlabel";
			public const string ops_industry = "ops_industry";
			public const string ops_industrytype = "ops_industrytype";
			public const string ops_legalname = "ops_legalname";
			public const string ops_linkedin = "ops_linkedin";
			public const string ops_linkedinsalesnav = "ops_linkedinsalesnav";
			public const string ops_ntontags = "ops_ntontags";
			public const string ops_tagsrefreshtriggeron = "ops_tagsrefreshtriggeron";
			...
			public const string Referencedops_account_account_formeraccountatlocation = "Referencedops_account_account_formeraccountatlocation";
			...
			public const string Referencingops_account_account_formeraccountatlocation = "ops_account_account_formeraccountatlocation";
		}
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_accesstype")]
		public Microsoft.Xrm.Sdk.EntityReference ops_accesstype
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("ops_accesstype");
			}
			set
			{
				this.SetAttributeValue("ops_accesstype", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_accountrefreshtagsrunurl")]
		public string ops_accountrefreshtagsrunurl
		{
			get
			{
				return this.GetAttributeValue<string>("ops_accountrefreshtagsrunurl");
			}
			set
			{
				this.SetAttributeValue("ops_accountrefreshtagsrunurl", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_accounttype")]
		public Microsoft.Xrm.Sdk.EntityReference ops_accounttype
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("ops_accounttype");
			}
			set
			{
				this.SetAttributeValue("ops_accounttype", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_amenities")]
		public string ops_amenities
		{
			get
			{
				return this.GetAttributeValue<string>("ops_amenities");
			}
			set
			{
				this.SetAttributeValue("ops_amenities", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_courtcount")]
		public System.Nullable<int> ops_courtcount
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("ops_courtcount");
			}
			set
			{
				this.SetAttributeValue("ops_courtcount", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_courtsize")]
		public string ops_courtsize
		{
			get
			{
				return this.GetAttributeValue<string>("ops_courtsize");
			}
			set
			{
				this.SetAttributeValue("ops_courtsize", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_courtsurface")]
		public string ops_courtsurface
		{
			get
			{
				return this.GetAttributeValue<string>("ops_courtsurface");
			}
			set
			{
				this.SetAttributeValue("ops_courtsurface", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_createaccountfromgpd")]
		public System.Nullable<bool> ops_createaccountfromgpd
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("ops_createaccountfromgpd");
			}
			set
			{
				this.SetAttributeValue("ops_createaccountfromgpd", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_customerid")]
		public string ops_customerid
		{
			get
			{
				return this.GetAttributeValue<string>("ops_customerid");
			}
			set
			{
				this.SetAttributeValue("ops_customerid", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_datavalidation")]
		public string ops_datavalidation
		{
			get
			{
				return this.GetAttributeValue<string>("ops_datavalidation");
			}
			set
			{
				this.SetAttributeValue("ops_datavalidation", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_datavalidationrunurl")]
		public string ops_datavalidationrunurl
		{
			get
			{
				return this.GetAttributeValue<string>("ops_datavalidationrunurl");
			}
			set
			{
				this.SetAttributeValue("ops_datavalidationrunurl", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_datavalidationtriggeron")]
		public System.Nullable<System.DateTime> ops_datavalidationtriggeron
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("ops_datavalidationtriggeron");
			}
			set
			{
				this.SetAttributeValue("ops_datavalidationtriggeron", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_donotemailreason")]
		public string ops_donotemailreason
		{
			get
			{
				return this.GetAttributeValue<string>("ops_donotemailreason");
			}
			set
			{
				this.SetAttributeValue("ops_donotemailreason", value);
			}
		}
		
		/// <summary>
		/// Stores the email pattern: @domain.com
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_emailpattern")]
		public string ops_emailpattern
		{
			get
			{
				return this.GetAttributeValue<string>("ops_emailpattern");
			}
			set
			{
				this.SetAttributeValue("ops_emailpattern", value);
			}
		}
		
		/// <summary>
		/// Former account at location - deactivated account where a match by address 1 line 1 of an open account whether manually or by a process deactivates the former account
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_formeraccountatlocation")]
		public Microsoft.Xrm.Sdk.EntityReference ops_formeraccountatlocation
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("ops_formeraccountatlocation");
			}
			set
			{
				this.SetAttributeValue("ops_formeraccountatlocation", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_googleplaceid")]
		public string ops_googleplaceid
		{
			get
			{
				return this.GetAttributeValue<string>("ops_googleplaceid");
			}
			set
			{
				this.SetAttributeValue("ops_googleplaceid", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gp_id")]
		public string ops_gp_id
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gp_id");
			}
			set
			{
				this.SetAttributeValue("ops_gp_id", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gp_query")]
		public string ops_gp_query
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gp_query");
			}
			set
			{
				this.SetAttributeValue("ops_gp_query", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gp_refreshedon")]
		public System.Nullable<System.DateTime> ops_gp_refreshedon
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("ops_gp_refreshedon");
			}
			set
			{
				this.SetAttributeValue("ops_gp_refreshedon", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gp_refreshstatus")]
		public string ops_gp_refreshstatus
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gp_refreshstatus");
			}
			set
			{
				this.SetAttributeValue("ops_gp_refreshstatus", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gp_response")]
		public string ops_gp_response
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gp_response");
			}
			set
			{
				this.SetAttributeValue("ops_gp_response", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gp_responsejson")]
		public string ops_gp_responsejson
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gp_responsejson");
			}
			set
			{
				this.SetAttributeValue("ops_gp_responsejson", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gp_responsestatus")]
		public string ops_gp_responsestatus
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gp_responsestatus");
			}
			set
			{
				this.SetAttributeValue("ops_gp_responsestatus", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_address1_city")]
		public string ops_gpd_address1_city
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_address1_city");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_address1_city", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_address1_county")]
		public string ops_gpd_address1_county
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_address1_county");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_address1_county", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_address1_latitude")]
		public System.Nullable<decimal> ops_gpd_address1_latitude
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<decimal>>("ops_gpd_address1_latitude");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_address1_latitude", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_address1_line1")]
		public string ops_gpd_address1_line1
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_address1_line1");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_address1_line1", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_address1_longitude")]
		public System.Nullable<decimal> ops_gpd_address1_longitude
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<decimal>>("ops_gpd_address1_longitude");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_address1_longitude", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_address1_postalcode")]
		public string ops_gpd_address1_postalcode
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_address1_postalcode");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_address1_postalcode", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_address1_stateorprovince")]
		public string ops_gpd_address1_stateorprovince
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_address1_stateorprovince");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_address1_stateorprovince", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_businessname")]
		public string ops_gpd_businessname
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_businessname");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_businessname", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_businessstatus")]
		public string ops_gpd_businessstatus
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_businessstatus");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_businessstatus", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_editorialsummary")]
		public string ops_gpd_editorialsummary
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_editorialsummary");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_editorialsummary", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_enrichmentapprovalstatus")]
		public Microsoft.Xrm.Sdk.EntityReference ops_gpd_enrichmentapprovalstatus
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("ops_gpd_enrichmentapprovalstatus");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_enrichmentapprovalstatus", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_enrichmentmodifiedby")]
		public Microsoft.Xrm.Sdk.EntityReference ops_gpd_enrichmentmodifiedby
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("ops_gpd_enrichmentmodifiedby");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_enrichmentmodifiedby", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_enrichmentmodifiedon")]
		public System.Nullable<System.DateTime> ops_gpd_enrichmentmodifiedon
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("ops_gpd_enrichmentmodifiedon");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_enrichmentmodifiedon", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_matchconfidence")]
		public System.Nullable<decimal> ops_gpd_matchconfidence
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<decimal>>("ops_gpd_matchconfidence");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_matchconfidence", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_matchconfidencetriggeredby")]
		public Microsoft.Xrm.Sdk.EntityReference ops_gpd_matchconfidencetriggeredby
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("ops_gpd_matchconfidencetriggeredby");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_matchconfidencetriggeredby", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_matchconfidencetriggeredon")]
		public System.Nullable<System.DateTime> ops_gpd_matchconfidencetriggeredon
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("ops_gpd_matchconfidencetriggeredon");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_matchconfidencetriggeredon", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_phonenumber")]
		public string ops_gpd_phonenumber
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_phonenumber");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_phonenumber", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_rating")]
		public System.Nullable<decimal> ops_gpd_rating
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<decimal>>("ops_gpd_rating");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_rating", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_refreshedon")]
		public System.Nullable<System.DateTime> ops_gpd_refreshedon
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("ops_gpd_refreshedon");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_refreshedon", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_responsejson")]
		public string ops_gpd_responsejson
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_responsejson");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_responsejson", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_responsestatus")]
		public string ops_gpd_responsestatus
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_responsestatus");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_responsestatus", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_url")]
		public string ops_gpd_url
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_url");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_url", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_url2")]
		public string ops_gpd_url2
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_url2");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_url2", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_userratingtotal")]
		public System.Nullable<int> ops_gpd_userratingtotal
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("ops_gpd_userratingtotal");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_userratingtotal", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_websiteurl")]
		public string ops_gpd_websiteurl
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_websiteurl");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_websiteurl", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_gpd_websiteurl2")]
		public string ops_gpd_websiteurl2
		{
			get
			{
				return this.GetAttributeValue<string>("ops_gpd_websiteurl2");
			}
			set
			{
				this.SetAttributeValue("ops_gpd_websiteurl2", value);
			}
		}
		
		/// <summary>
		/// ie 8/2025 LinkedIn Consulting, Delivery, Hiring Directors
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_importlabel")]
		public string ops_importlabel
		{
			get
			{
				return this.GetAttributeValue<string>("ops_importlabel");
			}
			set
			{
				this.SetAttributeValue("ops_importlabel", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_industry")]
		public string ops_industry
		{
			get
			{
				return this.GetAttributeValue<string>("ops_industry");
			}
			set
			{
				this.SetAttributeValue("ops_industry", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_industrytype")]
		public virtual System.Collections.Generic.IEnumerable<ops_industrytype> ops_industrytype
		{
			get
			{
				return EntityOptionSetEnum.GetMultiEnum<ops_industrytype>(this, "ops_industrytype");
			}
			set
			{
				this.SetAttributeValue("ops_industrytype", EntityOptionSetEnum.GetMultiEnum(this, "ops_industrytype", value));
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_legalname")]
		public string ops_legalname
		{
			get
			{
				return this.GetAttributeValue<string>("ops_legalname");
			}
			set
			{
				this.SetAttributeValue("ops_legalname", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_linkedin")]
		public string ops_linkedin
		{
			get
			{
				return this.GetAttributeValue<string>("ops_linkedin");
			}
			set
			{
				this.SetAttributeValue("ops_linkedin", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_linkedinsalesnav")]
		public string ops_linkedinsalesnav
		{
			get
			{
				return this.GetAttributeValue<string>("ops_linkedinsalesnav");
			}
			set
			{
				this.SetAttributeValue("ops_linkedinsalesnav", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_ntontags")]
		public string ops_ntontags
		{
			get
			{
				return this.GetAttributeValue<string>("ops_ntontags");
			}
			set
			{
				this.SetAttributeValue("ops_ntontags", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_tagsrefreshtriggeron")]
		public System.Nullable<System.DateTime> ops_tagsrefreshtriggeron
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("ops_tagsrefreshtriggeron");
			}
			set
			{
				this.SetAttributeValue("ops_tagsrefreshtriggeron", value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Ops.Plugins.Model.Account> Referencedaccount_master_account
		{
			get
			{
				return this.GetRelatedEntities<Ops.Plugins.Model.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<Ops.Plugins.Model.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Ops.Plugins.Model.Account> Referencedaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntities<Ops.Plugins.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<Ops.Plugins.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Ops.Plugins.Model.Account> Referencedmsa_account_managingpartner
		{
			get
			{
				return this.GetRelatedEntities<Ops.Plugins.Model.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<Ops.Plugins.Model.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		
		/// <summary>
		/// 1:N ops_account_account_formeraccountatlocation
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ops_account_account_formeraccountatlocation", Microsoft.Xrm.Sdk.EntityRole.Referenced)]
		public System.Collections.Generic.IEnumerable<Ops.Plugins.Model.Account> Referencedops_account_account_formeraccountatlocation
		{
			get
			{
				return this.GetRelatedEntities<Ops.Plugins.Model.Account>("ops_account_account_formeraccountatlocation", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<Ops.Plugins.Model.Account>("ops_account_account_formeraccountatlocation", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public Ops.Plugins.Model.Account Referencingaccount_master_account
		{
			get
			{
				return this.GetRelatedEntity<Ops.Plugins.Model.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public Ops.Plugins.Model.Account Referencingaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntity<Ops.Plugins.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntity<Ops.Plugins.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		...
		public Ops.Plugins.Model.Account Referencingmsa_account_managingpartner
		{
			get
			{
				return this.GetRelatedEntity<Ops.Plugins.Model.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntity<Ops.Plugins.Model.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		
		/// <summary>
		/// N:1 ops_account_account_formeraccountatlocation
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ops_formeraccountatlocation")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ops_account_account_formeraccountatlocation", Microsoft.Xrm.Sdk.EntityRole.Referencing)]
		public Ops.Plugins.Model.Account Referencingops_account_account_formeraccountatlocation
		{
			get
			{
				return this.GetRelatedEntity<Ops.Plugins.Model.Account>("ops_account_account_formeraccountatlocation", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntity<Ops.Plugins.Model.Account>("ops_account_account_formeraccountatlocation", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
	}
}
